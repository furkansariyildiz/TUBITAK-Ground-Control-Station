...
var img = new Image();
	img.src = "Images/mf7_th.png";
 ROS2D.NavigationArrowImages = function (options) {
	var that = this;
	options = options || {};
	var size = options.size || 10;
	var strokeSize = options.strokeSize || 3;
	...
	*/
	...
	graphics.beginBitmapFill(img,'no-repeat');
...
ROS2D.NavigationArrowImages.prototype.__proto__ = createjs.Shape.prototype;
...
ROS2D.Viewer = function(options) {
  ...
  var background = options.background || '#dcdcdc';
